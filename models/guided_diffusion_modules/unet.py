...
# from module_test.a1_CRA import *
# from module_test.a2_SHViTBlock import *
from module_test.a8_CMUNeXtBlock import *
...
# )
# import sys
# sys.path.append(r'D:\code\1220\256_fid_lpips_linux\o256_m12_fid_lpips')
# from module_test.a8_CMUNeXtBlock import *
...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        self.middle_block = EmbedSequential(
            ...
            #     use_scale_shift_norm=use_scale_shift_norm,
            # ),
            CMUNeXtBlock(ch_in=ch, ch_out=ch, kernel_size=3, stride=1),
            AttentionBlock(
                ch,
                use_checkpoint=use_checkpoint,
                num_heads=num_heads,
